...
var paths = {
    ...
    resources: {
        ...
        js:     'src/',      // Resource JavaScript folder
        scss:   'src/'       // Resource SCSS folder
    }
};
...
gulp.task('watch', function() {
    ...
    gulp.watch(paths.examples.root + '**/*.*', reload);
});

gulp.task('build', gulp.series('sass','js'));
gulp.task('default', gulp.series('build', gulp.parallel('watch','serve')));
gulp.task('example', gulp.series('serve'));
